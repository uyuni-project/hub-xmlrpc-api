...
minions_per_server = client.multicast.system.listSystems(hubKey, serverIds)
...
action_id = client.multicast.system.schedulePackageInstall(hubKey, serverIds, minion_ids, package_ids, start_times)
print(action_id)

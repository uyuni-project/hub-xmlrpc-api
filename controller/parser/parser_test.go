...
func Test_MulticastRequestParser(t *testing.T) {
	tt := []struct {
		...
		{name: "MulticastRequestParser Success",
			serverRequest:   &codec.ServerRequest{"multicast.method", []interface{}{"hubSessionKey", []interface{}{int64(1), int64(2)}, []interface{}{"arg1_Server1", "arg1_Server2"}, []interface{}{"arg2_Server1", "arg2_Server2"}}},
		...
		{name: "MulticastRequestParser no_serverID_passed Failed",
			serverRequest:   &codec.ServerRequest{"multicast.method", []interface{}{"hubSessionKey", []interface{}{"serverSessionKey"}}},
			structToHydrate: &controller.MulticastRequest{},
			expectedStruct:  controller.MulticastRequest{},
			expectedError:   controller.FaultInvalidParams.Message},
		{name: "MulticastRequestParser malformed_hubSessionKey Failed",
			serverRequest:   &codec.ServerRequest{"multicast.method", []interface{}{1, []interface{}{int64(2)}, []interface{}{"arg1_Server1"}}},
			structToHydrate: &controller.MulticastRequest{},
			expectedStruct:  controller.MulticastRequest{},
			expectedError:   controller.FaultInvalidParams.Message},
		{name: "MulticastRequestParser malformed_serverID Failed",
			serverRequest:   &codec.ServerRequest{"multicast.method", []interface{}{"hubSessionKey", []interface{}{"1", "2"}, []interface{}{"arg1_Server1", "arg1_Server2"}, []interface{}{"arg2_Server1", "arg2_Server2"}}},
			structToHydrate: &controller.MulticastRequest{},
			expectedStruct:  controller.MulticastRequest{},
			expectedError:   controller.FaultInvalidParams.Message},
		{name: "MulticastRequestParser no_MulticastRequest_passed Failed",
			serverRequest:   &codec.ServerRequest{"multicast.method", []interface{}{"hubSessionKey", []interface{}{int64(1)}, "arg1_Server1", "arg2_Server1"}},
			structToHydrate: &controller.UnicastRequest{},
			expectedStruct:  controller.MulticastRequest{},
			expectedError:   controller.FaultInvalidParams.Message},
...
func Test_UnicastRequestParser(t *testing.T) {
	tt := []struct {
		...
		{name: "UnicastRequestParser Success",
			serverRequest:   &codec.ServerRequest{"unicast.method", []interface{}{"sessionKey", int64(1), "arg1_Server1", "arg2_Server1"}},
			structToHydrate: &controller.UnicastRequest{},
		...
		{name: "UnicastRequestParser wrong_number_of_arguments Failed",
			serverRequest:   &codec.ServerRequest{"unicast.method", []interface{}{"sessionKey"}},
			structToHydrate: &controller.UnicastRequest{},
			expectedStruct:  controller.UnicastRequest{},
			expectedError:   controller.FaultWrongArgumentsNumber.Message},
		{name: "UnicastRequestParser malformed_hubSessionKey Failed",
			serverRequest:   &codec.ServerRequest{"unicast.method", []interface{}{123, "1", "arg1_Server1", "arg2_Server1"}},
			structToHydrate: &controller.UnicastRequest{},
			expectedStruct:  controller.UnicastRequest{},
			expectedError:   controller.FaultInvalidParams.Message},
		{name: "UnicastRequestParser malformed_serverId Failed",
			serverRequest:   &codec.ServerRequest{"unicast.method", []interface{}{"sessionKey", "1", "arg1_Server1", "arg2_Server1"}},
			structToHydrate: &controller.UnicastRequest{},
			expectedStruct:  controller.UnicastRequest{},
			expectedError:   controller.FaultInvalidParams.Message},

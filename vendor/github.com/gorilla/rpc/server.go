...
// RegisterDefaultService adds a new service to the server.
//
// The name parameter is optional: if empty it will be inferred from
// the receiver type name.
//
...
//
// All other methods are ignored.
func (s *Server) RegisterDefaultService(receiver interface{}, defaultMethodName string) error {
	s.defaultMethod = defaultMethodName
	return s.RegisterService(receiver, "")
}
...
func (s *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	if errGet != nil {
		serviceSpec, methodSpec, errGet = s.services.get(s.defaultMethod)
		if errGet != nil {
